...
const wflowprocess = {
    ...
    /**
     * 同意审批 wflowAddUsers , wflowNotifyUsers
     * @param curRow 当前被选中记录数据
     * @param fixedWFlow
     * @param data
     */
    async handleApproveWF(curRow = '', fixedWFlow = '', data = [], tasktype = 'wait') {
     ...
     * 生成任务记录数据
     */
    async handleTaskItem(data, curRow, result = "") {
...
var wflowprocessExports = {
    wflowprocess,
}

module.exports = wflowprocessExports